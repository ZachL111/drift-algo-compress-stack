...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-drift-algo-compress-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-drift-algo-compress-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-drift-algo-compress-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-drift_algo_compress_stack-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
