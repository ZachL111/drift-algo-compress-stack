"""Regression checks for the drift-algo-compress-stack casebook."""
...
from casebook.harness import assert_expected, drift_algo_compress_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_algo_compress_stack_summary(), assert_expected())
